...
def add_logo_to_image(frame_image_path, logo_image_path, output_image_path, target_width, target_height):
    # Mở ảnh nền (test.jpg)
    ...
    # Cắt logo thành hình chữ nhật với kích thước mong muốn
    logo = logo.crop((0, 0, target_width, target_height))
    ...
    # Tính toán vị trí đặt logo: căn giữa theo chiều ngang và ở trên cùng
    position = (frame.width // 2 - logo.width // 2, 0)  # Đặt ở trên cùng
...
target_height = 100  # Chiều cao mong muốn

# Chèn logo vào ảnh nền
add_logo_to_image(frame_image_path, logo_image_path, output_image_path, target_width, target_height)
